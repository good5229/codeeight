var SITE_BOOKING = function(){
	...
	var init_view = function(no,d,st,s,e, dt, md,ia){
		idx = no;
		data = d;
		duration_type = dt;
		max_day = md;
	...
	return{
		...
		'init_view' : function(idx,data,st,s,e, duration_type, max_day,ia){
			init_view(idx,data,st,s,e, duration_type, max_day,ia);
		},
